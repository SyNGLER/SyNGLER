...
def main():
    ...
    ap.add_argument(
        "--base-yaml",
        default="config/gran_youtube.yaml",
    ...
    ap.add_argument("--n", type=int, default=2000, help="Upper bound for number of nodes.")
    ...
    for seed in range(args.seed_start, args.seed_end + 1):
        ...
        # Clone and specialize config for this seed
        ...
        # Run id for distinguishing logs
        cfg["run_id"] = f"gran_youtube_seed{seed}"
        ...
        tmp_yaml = f"{out_dir}/_auto_gran_youtube_seed_{seed}.yaml"
